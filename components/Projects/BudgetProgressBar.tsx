...
const BudgetProgressBar: React.FC<BudgetProgressBarProps> = ({
  ...
  return (
    <div className='w-full border-t pt-3'>
      ...
      <span className='text-sm font-medium text-gray-700'> {`$${paidAmount.toLocaleString()} / $${budget.toLocaleString()}`} </span>
      </div>
      <div className='w-full bg-gray-200 rounded-full h-2.5'>
        <div
          className={cn('bg-yellow-400 h-2.5 rounded-full', paidPercentage > 50 && 'bg-green-600')}
